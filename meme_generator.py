...
class MemeGenerator:
    ...
    def generate_meme(self, image_path, top_text, bottom_text, output_path):
        try:
            ...
            # Calculate text sizes
            top_text_size = draw.textbbox((0, 0), top_text, font=self.font)
            bottom_text_size = draw.textbbox((0, 0), bottom_text, font=self.font)

            top_text_width = top_text_size[2] - top_text_size[0]
            top_text_height = top_text_size[3] - top_text_size[1]

            bottom_text_width = bottom_text_size[2] - bottom_text_size[0]
            bottom_text_height = bottom_text_size[3] - bottom_text_size[1]
